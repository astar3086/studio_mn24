...
class Smarty extends Smarty_Internal_TemplateBase
{
	 ...
	 * @param $config_dir
	 * @internal param array|string $template_dir directory(s) of configuration sources
	 * @return Smarty       current Smarty instance for chaining
	 */
	 ...
	 * @param $plugins_dir
	 * @internal param object $smarty
	 * @internal param $string $ |array $ plugins folder
	 * @return Smarty current Smarty instance for chaining
	 */
	 ...
	 * @internal param object $templae template object
