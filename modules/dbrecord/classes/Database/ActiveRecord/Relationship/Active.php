...
/**
 * Class Active is the base class for representing active relations that bring back related objects.
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package Database\ActiveRecord\Relationship
 * @since 1.0
 */

class Active extends BaseActive
{
	/**
	 ...
	 * For more details about this property, see {@link \Database\ActiveRecord\Record::with()}.
	 */
	public $with=[];
	/**
