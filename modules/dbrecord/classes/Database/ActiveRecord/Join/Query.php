...
/**
 * \Database\ActiveRecord\Join\Query represents a JOIN SQL statement.
 *
...
class Query
{
	...
	/**
	 * Constructor.
	 * @param \Database\ActiveRecord\Join\Element $joinElement The root join tree.
	 ...
	 * @param \Database\ActiveRecord\Join\Element $element the element to be joined
	 */
