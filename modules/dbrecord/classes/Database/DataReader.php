 ...
 * @package Database
 */
class DataReader /*extends CComponent */implements \Iterator, \Countable
{
	/**
	 * @var
	 */
	 ...
	 * @throws \Database\Exception if this method is invoked twice
	 */
	public function rewind()
	{
		if($this->_index<0)
		{
			...
			throw new \Database\Exception(Yii::t('yii','CDbDataReader cannot rewind. It is a forward-only reader.'));
	}
