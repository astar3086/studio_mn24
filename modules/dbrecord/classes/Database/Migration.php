 ...
 * Compared with the same methods in {@link \Database\Command}, these methods will display extra
 * information showing the method parameters and execution time, which may be useful when
 * applying migrations.
 *
 * @property \Database\Connection $dbConnection The currently active database connection.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db
 * @since 1.1.6
...
abstract class Migration/*extends CComponent*/
{
	 ...
	 * @throws \Database\Exception if "db" application component is not configured
	 * @return Connection the currently active database connection
	 */
	public function getDbConnection()
	{
		if($this->_db===null)
		{
			...
			if(!$this->_db instanceof Connection)
				throw new \Database\Exception(Yii::t('yii', 'The "db" application component must be configured to be a \Database\Connection object.'));
		}
		return $this->_db;
	}
	 ...
	 * @param \Database\Connection $db the database connection component
	 */
	 ...
	 * @param array $params input parameters (name=>value) for the SQL execution. See {@link \Database\Command::execute} for more details.
	 * @since 1.1.7
	 */
	 ...
	 * refer to {@link \Database\Command::where} on how to specify conditions.
