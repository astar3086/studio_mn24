<?php
/**
 * \Database\schema\Schema class file.
 *
...
/**
 * \Database\schema\Schema is the base class for retrieving metadata information.
 *
 * @property \Database\Connection $dbConnection Database connection. The connection is active.
 * @property array $tables The metadata for all tables in the database.
 * Each array element is an instance of {@link \Database\schema\TableSchema} (or its child class).
 * The array keys are table names.
 * @property array $tableNames All table names in the database.
 * @property Database\schema\CommandBuilder $commandBuilder The SQL command builder for this connection.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
abstract class Schema/* extends CComponent*/
{
	...
	/**
	 * Constructor.
	 * @param \Database\Connection $conn database connection.
	 */
	...
	/**
	 * @return \Database\Connection database connection. The connection is active.
	 */
	 ...
	 * @return \Database\schema\TableSchema table metadata. Null if the named table does not exist.
	 */
	 ...
	 * @param \Database\schema\TableSchema $table the table schema whose primary key sequence will be reset
