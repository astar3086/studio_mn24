...
/**
 * \Database\schema\TableSchema is the base class for representing the metadata of a database table.
 *
 * It may be extended by different DBMS driver to provide DBMS-specific table metadata.
 *
 * \Database\schema\TableSchema provides the following information about a table:
 * <ul>
 * <li>{@link name}</li>
 * <li>{@link rawName}</li>
 * <li>{@link columns}</li>
...
class TableSchema/* extends CComponent*/
{
	/**
	 ...
	 * @return TableSchema metadata of the named column. Null if the named column does not exist.
	 */
