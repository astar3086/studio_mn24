<?php
/**
 * \Database\schema\Criteria class file.
 *
...
/**
 * \Database\schema\Criteria represents a query criteria, such as conditions, ordering by, limit/offset.
 *
 * It can be used in AR query methods such as \Database\ActiveRecord\Record::find and \Database\ActiveRecord\Record::findAll.
 *
 * $criteria=new \Database\schema\Criteria();
...
class Criteria/* extends CComponent*/
{
	 ...
	 * This property is effective only when the criteria is passed as a parameter to the following methods of \Database\ActiveRecord\Record:
	 * <ul>
	 * <li>{@link \Database\ActiveRecord\Record::find()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::findAll()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::findByPk()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::findAllByPk()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::findByAttributes()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::findAllByAttributes()}</li>
	 * <li>{@link \Database\ActiveRecord\Record::count()}</li>
	 * </ul>
	 * The property value will be used as the parameter to the {@link \Database\ActiveRecord\Record::with()} method
	 * to perform the eager loading. Please refer to {@link \Database\ActiveRecord\Record::with()} on how to specify this parameter.
	 * @since 1.1.0
	 */
	public $with;
	/**
	 ...
	 * @return \Database\schema\Criteria the criteria object itself
	 */
	 ...
	 * @param mixed $criteria the criteria to be merged with. Either an array or \Database\schema\Criteria.
