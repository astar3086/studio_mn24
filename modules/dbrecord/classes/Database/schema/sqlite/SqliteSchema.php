 ...
 * @since 1.0
 */
class CSqliteSchema extends \Database\schema\Schema
{
	/**
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Dropping DB column is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Renaming a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Adding a foreign key constraint to an existing table is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Dropping a foreign key constraint is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Altering a DB column is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Adding a primary key after table has been created is not supported by SQLite.'));
	}
	...
	{
		throw new \Database\Exception(Yii::t('yii', 'Removing a primary key after table has been created is not supported by SQLite.'));
