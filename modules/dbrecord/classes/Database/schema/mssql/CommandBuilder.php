 ...
 */
namespace classes\Database\schema\mssql;
use \classes\Database\schema as BaseSchema;
class CommandBuilder extends BaseSchema
{
	/**
	 * Creates a COUNT(*) command for a single table.
	 * Override parent implementation to remove the order clause of criteria if it exists
	 * @param \Database\schema\TableSchema $table the table metadata
	 ...
	 * @param \Database\schema\Criteria $criteria the query criteria
	 * @throws \Database\Exception if no columns are being updated
	...
	public function createUpdateCommand($table,$data,$criteria)
	{
		...
		foreach($data as $name=>$value)
		{
			if(($column=$table->getColumn($name))!==null)
			{
				...
				if($value instanceof \Database\schema\Expression)
				{
		...
		if($fields===[])
			throw new \Database\Exception(Yii::t('yii','No columns are being updated for table "{table}".',
				['{table}'=>$table->name]));
	 ...
	 * Override parent implementation to check if an orderby clause if specified when querying with an offset
	 * @param \Database\schema\TableSchema $table the table metadata
	 * @param \Database\schema\Criteria $counters the query criteria
	 ...
	 * @throws \Database\Exception if no counter is specified
	 */
	 ...
	 * @param \Database\schema\Criteria $criteria criteria
	 * @return \Database\schema\Criteria the modified criteria
	 */
