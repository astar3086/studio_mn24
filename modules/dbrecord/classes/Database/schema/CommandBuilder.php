<?php
/**
 * \Database\CommandBuilder class file.
 *
...
/**
 * \Database\CommandBuilder provides basic methods to create query commands for tables.
 *
 * @property \Database\Connection $dbConnection Database connection.
 * @property \Database\schema\Schema $schema The schema for this command builder.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CommandBuilder/* extends CComponent*/
{
	...
	/**
	 * @param \Database\schema\Schema $schema the schema for this command builder
	 */
	...
	/**
	 * @return \Database\schema\Schema the schema for this command builder.
	 */
	 ...
	 * @param mixed $table the table schema ({@link \Database\schema\TableSchema}) or the table name (string).
	 ...
	 * @return \Database\Command query command.
	 */
	 ...
	 * @param mixed $table the table schema ({@link \Database\schema\TableSchema}) or the table name (string).
	 * @param Criteria $criteria the query criteria
	 * @return \Database\Command delete command.
	 */
	 ...
	 * @return \Database\Command insert command
	 */
	public function createInsertCommand($table,$data)
	{
		...
		if($fields===[])
		{
			$pks=is_array($table->primaryKey) ? $table->primaryKey : [$table->primaryKey];
			foreach($pks as $pk)
			{
	 ...
	 * @return \Database\Command multiple insert command
	 * @since 1.1.14
	 */
	 ...
	 * @return \Database\Command update command.
	 */
	 ...
	 * @param Criteria $criteria the query criteria
	 * @throws Exception if no columns are being updated for the given table
	 * @return \Database\Command the created command
	 */
	public function createUpdateCounterCommand($table,$counters,$criteria)
	{
		...
		if($fields!==[])
		{
			...
			throw new Exception(Yii::t('yii','No counter columns are being updated for table "{table}".',
				['{table}'=>$table->name]));
	}
	 ...
	 * @return \Database\Command the created command
	 */
	public function createSqlCommand($sql,$params=[])
	{
		$command=$this->_connection->createCommand($sql);
	 ...
	 * @param \Database\Command $command database command
	 ...
	 * @param \Database\schema\TableSchema $table the table schema
	 * @param array $values list of primary key values to be selected within
	 ...
	 * @param mixed $table table schema ({@link \Database\schema\TableSchema}) or table name (string).
