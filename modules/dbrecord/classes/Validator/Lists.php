 ...
 * @since 1.0
 */
class Lists extends \Component implements \IteratorAggregate,\ArrayAccess,\Countable
{
	/**
	...
	{
		return new ListsIterator($this->_d);
	}
	...
	public function itemAt($index)
	{
		...
		elseif($index>=0 && $index<$this->_c) // in case the value is null
			...
			throw new \Kohana_Exception('List index "{index}" is out of bound.',
				['{index}'=>$index]);
	}
