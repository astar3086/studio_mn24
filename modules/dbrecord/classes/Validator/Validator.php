<?php
    ...
    abstract class Validator extends \Component
    {
        ...
        public static function createValidator($name, $object, $attributes, $params = [])
        {
            ...
            //$validator = new Validators\InlineValidator();
            ...
            else
            {
                ...
                {
                    $className = 'Validator\validators\\'.self::$builtInValidators[$name];
                }
                else
                {
                    $className = $name;
            ...
            $validator->on = empty($on) ? [] : array_combine($on, $on);
            $validator->except = empty($except) ? [] : array_combine($except, $except);
