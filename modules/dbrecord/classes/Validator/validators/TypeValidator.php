...
namespace Validator\validators;
     ...
     * TypeValidator allows for the following placeholders to be specified:
     * <ul>
     ...
     * @since   1.0
     */
    class TypeValidator extends \Validator\Validator
    {
        /**
        ...
        public function validateValue($value)
        {
            ...
            elseif($type === 'date')
            {
                return CDateTimeParser::parse($value, $this->dateFormat,
                    ['month' => 1, 'day' => 1, 'hour' => 0, 'minute' => 0, 'second' => 0]) !== false;
            }
            elseif($type === 'time')
            {
