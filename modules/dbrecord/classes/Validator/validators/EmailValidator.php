<?php
     ...
     * @since   1.0
     */
    class EmailValidator extends \Validator\Validator
    {
        /**
        ...
        public function validateValue($value)
        {
            ...
            $valid = is_string($value) && strlen($value) <= 254 && (preg_match($this->pattern,
                        $value) || $this->allowName && preg_match($this->fullPattern, $value));
            if($valid)
            {
