<?php
     ...
     *
     * @property \Validator\Lists        $validatorList      All the validators declared in the model.
     ...
     * @package classes
     */
    abstract class Model extends \Component implements \IteratorAggregate, \ArrayAccess
    {
        ...
        public function createValidators()
        {
            ...
            foreach($this->rules() as $rule)
            {
                ...
                {
                    $validators->add(\Validator\Validator::createValidator($rule[1], $this, $rule[0],
                        array_slice($rule, 2)));
                }
                else
                {
                    throw new \Database\Exception('{class} has an invalid validation rule. The rule must specify attributes to be validated and the validator name.',
        ...
        {
            return ucwords(trim(strtolower(str_replace(['-', '_', '.'], ' ',
