...
class Assets_Core {
	 ...
	 * @param null $deps
	 * @param bool $footer
	 * @internal param \Asset $mixed name if `string`, sets `$footer` if boolean
	 * @internal param \Asset $string source
	 * @internal param \Dependencies $mixed
	 * @internal param \Whether $bool to show in header or footer
	 * @return  mixed    Setting returns asset array, getting returns asset HTML
	 */
