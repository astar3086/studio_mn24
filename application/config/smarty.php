...
return [
	...
	'smarty_class_file' => MODPATH.'smarty'.DS.'smarty'.DS.'Smarty.class'.EXT,
	...
	'smarty_config'     => [
		...
		'compile_dir'       => Kohana::$cache_dir.DS.'smarty'.DS.'compile'.DS,
		// ... and the smarty cache (only used if it is enabled)
		'cache_dir'         => Kohana::$cache_dir.DS.'smarty'.DS.'cache'.DS,
		...
		'plugins_dir'       => [
			...
			MODPATH.'smarty'.DS.'core'.DS.'plugins',
			//'plugins',
		],
		...
		'base_UI' => Kohana::$base_url.'template/default/',
