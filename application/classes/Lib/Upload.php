...
class Upload
{
	...
	protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new \stdClass();
        $file->name = $this->get_file_name($uploaded_file, md5($name.time()).'.jpg', $size, $type, $error,
            $index, $content_range);
	...
	public function delete($print_response = true) {
        ...
        foreach($file_names as $file_name) {
            ...
            if ($success) {
                ...
                $dir_path = str_replace("/".$file_name,"",$file_path);
                rmdir( $dir_path.'/thumbnail' );
                rmdir( $dir_path.'/medium' );
                rmdir( $dir_path.'/large' );
                rmdir( $dir_path );
            }
